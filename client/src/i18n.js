...
const resources = {
  ...
  vi: {
    translation: {
      ...
      modal_confirm_delete_volunteer_content: "Xác nhận bạn muốn xóa tình nguyện viên này",
      modal_confirm_delete_student_title: "Xác nhận xóa học sinh",
      modal_confirm_delete_student_content: "Xác nhận bạn muốn xóa tình nguyện viên này",
      //validation:
