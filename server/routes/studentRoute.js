...
const { addNewStudent, getStudents, getStudentInfo, editStudent, deleteStudentData, updateStudentOverview, changeStudentStatus } = require("../controllers/studentController");
...
router.post("/:id/change-status", checkAdminAndMonitorRole, changeStudentStatus);
